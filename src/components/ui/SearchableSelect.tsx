...
export default function SearchableSelect({ name, options, defaultValue = "", placeholder = "Seçiniz...", onChange }: SearchableSelectProps) {
  ...
  return (
    <div className="relative w-full" ref={containerRef}>
      ...
      {/* Trigger Button */}
      <div 
        className="w-full flex items-center justify-between text-sm text-slate-700 bg-slate-50 border border-slate-200 px-3 py-2.5 rounded-lg mb-3 outline-none focus-within:border-emerald-500 cursor-pointer transition-colors"
